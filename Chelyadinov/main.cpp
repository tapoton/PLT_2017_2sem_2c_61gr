 ...
 //Для заданного текста подсчитать кол-во слов состоящих только из согласных букв, используя trie деревья
...
private:
    ...
    {
   /* for(int i=0; i<26; i++)                //крашится на комбинациях "kot kit ktr ktra","tar tir tdj tdje" и т.п. 
                                            //на других кобинациях работает
        {                                    //в чем проблема не выяснил
        if(q->Liter[i]!=NULL){
