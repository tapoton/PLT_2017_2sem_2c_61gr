...
/*
Цыганкова Елизавета 2 курс 61 группа
Лабораторная №5
В текстовом файле задана прямоугольная матрица. 
Отсортировать файл в порядке возрастания сумм первых и последних элементов строк матрицы 
*/
#include <cstdlib>
#include <iostream>
#include <stdio.h>
